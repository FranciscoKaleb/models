...
llm = Llama(
    ...
    n_gpu_layers=0,        # -1 = put ALL layers on GPU (fits entirely in your 12GB VRAM)
    n_ctx=2048,             # context window (how much conversation it remembers)
...
print("=" * 50)
print("  Phi3 Chat  |  type 'exit' to quit")
